...
Please check [this post](https://altay.wtf/posts/decade) to read more about how I approach software development.
...
- React Query, Jotai, XState for state management
- tRPC, GraphQL, REST APIs for networking
...
- I've done this full time in 2017-18 and 2021-23, still involved as a contractor when I have other full-time commitments.
...
- Graduated second in the department with additional coursework in Computer Science and [Visual Communication Design](https://github.com/altaywtf/vcd-ibeacon).
- Built a [shuttle tracking app for the university](https://github.com/altaywtf/bilgi-shuttle-ios).
